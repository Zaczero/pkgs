...
INPUT_BUILDERS: dict[str, Callable[[], gm.Geometry]] = {
    ...
    'random_polygon_0': lambda: gm.Polygon([(2.444326621317076, -4.74989244777333), (1.9192973029479568, -3.8405149928947604), (0.8692386662097182, -3.84051499289476), (0.34420934784059876, -4.74989244777333), (0.8692386662097176, -5.6592699026519), (1.9192973029479568, -5.659269902651901)], crs=3857),
    'random_line_1': lambda: gm.LineString([*[(-1.6232852254132093, -3.9750482382849253), (-2.0868296731887934, -2.701470335107945), (-3.260565417678661, -2.023813687069234), (-4.595288459416237, -2.2591613711008387), (-5.466467053378228, -3.297391590246214), (-5.466467053378228, -4.652704886323636), (-4.5952884594162375, -5.690935105469011), (-3.260565417678662, -5.9262827895006165), (-2.0868296731887943, -5.248626141461906)], (-1.6232852254132093, -3.9750482382849253)], crs=3857),
    'random_polygon_2': lambda: gm.Polygon([(-3.5710172348296982, -0.7807818031472955), (-3.8508144542677685, -0.2961588032640594), (-4.410408893143909, -0.29615880326405936), (-4.690206112581979, -0.7807818031472954), (-4.410408893143909, -1.2654048030305316), (-3.8508144542677685, -1.2654048030305316)], crs=3857),
    'random_line_3': lambda: gm.LineString([*[(-1.050900940215378, 1.0201872904998037), (-1.4304915211489437, 2.063103840252438), (-2.391648612451435, 2.618028145649449), (-3.4846361290312164, 2.425304956898893), (-4.198033064677433, 1.5751115958968152), (-4.198033064677433, 0.46526298510279274), (-3.4846361290312178, -0.38493037589928525), (-2.391648612451436, -0.577653564649842), (-1.4304915211489442, -0.02272925925283098)], (-1.050900940215378, 1.0201872904998037)], crs=3857),
    'random_polygon_4': lambda: gm.Polygon([(0.25157962607791307, -0.5079095371614635), (-0.47836198015498393, 0.4967688926571845), (-1.6594323088425034, 0.11301588023033693), (-1.6594323088425036, -1.1288349545532637), (-0.4783619801549842, -1.5125879669801114)], crs=3857),
}
...
OP_RUNNERS: dict[str, Callable[[gm.Geometry], object]] = {
    ...
    'segmentize': lambda geom: _linework(geom).segmentize(0.5),
...
def test_kernel_parity_snapshot() -> None:
    if RECAPTURE or not GOLDEN_PATH.is_file():
